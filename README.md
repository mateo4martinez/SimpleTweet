...
* [x] New compose floating action button
* [x] Logout button as menu item in top right to avoid a big button in the middle of timeline

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://media.giphy.com/media/evMXXLLFazNOItooyC/giphy.gif' title='' width='' alt='' />
